...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '文章评论父类',
                'verbose_name_plural': '文章评论父类',
                'db_table': 'article_comment_manage',
            },
        ),
        migrations.CreateModel(
            name='ArticleCommentManageSon',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('creat_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', tinymce.models.HTMLField(verbose_name='文章主体内容')),
            ],
            options={
                'verbose_name': '文章管理',
        ...
        migrations.AddField(
            ...
            name='comment_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='article.ArticleManage', verbose_name='父评论id'),
        ),
    ]
